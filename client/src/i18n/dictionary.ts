...
export const dict = {
  ...
  te: {
    ...
    ob_gyn: "స్త్రీ వైద్య నిపుణుడు",
    medical_reviewer: "వైద్య సమీక్షకుడు", 
    ob_gyn_medical_reviewer: "స్త్రీ వైద్య నిపుణుడు — వైద్య సమీక్షకుడు",
    reproductive_medicine: "పునరుత్పత్తి వైద్యం",
    perinatal_psychology: "ప్రసవకాల మనోవిజ్ఞానం",
    mbbs_ms: "ఎంబీబీఎస్, ఎంఎస్",
    mbbs_dnb: "ఎంబీబీఎస్, డీఎన్‌బీ",
    phd_clinical_psychology: "పీహెచ్‌డీ క్లినికల్ సైకాలజీ",
    delhi: "ఢిల్లీ",
    bengaluru: "బెంగళూరు", 
    mumbai: "ముంబై",
    respectful_maternity_care: "గౌరవప్రదమైన మాతృత్వ సంరక్షణ మరియు రోగి విద్య।",
    evidence_based_fertility: "సాక్ష్య-ఆధారిత సంతానోత్పత్తి చికిత్సలు।",
    fertility_aware_mental_health: "సంతానోత్పత్తి-అవగాహన మానసిక ఆరోగ్య సంరక్షణ।",
  ...
  te: {
    ...
    investors_intro:
      "తక్కువ సేవలున్న కమ్యూనిటీలకు స్కేలబుల్ ఆరోగ్య మౌలిక సదుపాయాలు। సాక్ష్యాధార జ్ఞానం మరియు భావోద్వేగ మద్దతు వ్యవస్థల ద్వారా విశ్వాసం నిర్మించడం।",
    investors_platform_title: "ప్లాట్‌ఫారమ్",
    investors_platform_desc:
      "తల్లిదండ్రత్వ ప్రయాణంలో సిద్ధత స్థాయి; పునర్వినియోగ భాగాలు మరియు కంటెంట్ స్కీమా।",
    investors_model_title: "మోడల్",
    investors_model_desc:
      "ఫలితం-సమలేఖన పైలట్లు; సబ్స్క్రిప్షన్ + వినియోగ ధర (భవిష్యత్తు); చెల్లింపు లీడ్‌జెన్ లేదు।",
