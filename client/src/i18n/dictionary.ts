...
export const dict = {
  en: {
    ...
    treatment_iui_desc: "Intrauterine insemination process, success rates, and what to expect",
    treatment_ivf_title: "IVF", 
    treatment_ivf_desc: "In vitro fertilization steps, timeline, and preparation guide",
    treatment_icsi_title: "ICSI",
    treatment_icsi_desc: "Intracytoplasmic sperm injection for male factor infertility",
    treatment_donor_title: "Donor Options",
    treatment_donor_desc: "Egg, sperm, and embryo donation processes and considerations",
    treatment_preservation_title: "Fertility Preservation",
    treatment_preservation_desc: "Egg and sperm freezing for future family planning",
    ...
    chat_understand_anxiety: "I understand your anxiety. It's completely normal to feel this way before scans.",
  ...
  hi: {
    ...
    cta_primary: "साखी से मिलें", cta_secondary: "क्लिनिक के लिए",
    ...
    // Treatments - Hindi
    treatment_iui_title: "IUI",
    treatment_iui_desc: "अंतर्गर्भाशयी गर्भाधान प्रक्रिया, सफलता दर और क्या अपेक्षा करें",
    treatment_ivf_title: "IVF",
    ...
    treatment_preservation_desc: "भविष्य की पारिवारिक योजना के लिए अंडा और शुक्राणु संरक्षण",

    // Sakhi Features - Hindi
    sakhi_feature_emotional_title: "भावनात्मक सहयोग",
    sakhi_feature_emotional_desc: "चिंता, डर और अभिभूत क्षणों के लिए सहानुभूतिपूर्ण प्रतिक्रियाएं",
    ...
    sakhi_feature_private_desc: "सभी बातचीत आपके डिवाइस पर रहती है - पूर्णतः निजी",
    ...
    sakhi_feature_multilang_desc: "आपके इनपुट के आधार पर अंग्रेजी, हिंदी या तेलुगु में जवाब",
    ...
    chat_understand_anxiety: "मैं आपकी चिंता समझती हूं। स्कैन से पहले ऐसा महसूस करना पूरी तरह सामान्य है।",
  ...
  te: {
    ...
    // Journey stages
    journey_stage_1_title: "తల్లిదండ్రత్వ ఆలోచన",
    journey_stage_1_desc: "పోషణ, భావోద్వేగ సిద్ధత, ఆర్థిక ప్రణాళిక",
    journey_stage_2_title: "సహజంగా ప్రయత్నం",
    journey_stage_2_desc: "సైకిల్ ట్రాకింగ్, జీవనశైలి చిట్కాలు",
    journey_stage_3_title: "ఎంపికలను అన్వేషణ",
    journey_stage_3_desc: "IUI/IVF సిద్ధత, మీ వైద్యుడిని అడిగే ప్రశ్నలు",
    journey_stage_4_title: "గర్భధారణ",
    journey_stage_4_desc: "ట్రైమెస్టర్ మార్గదర్శనం, అపోహలు వర్సెస్ వాస్తవాలు",
    ...
    // Treatments - Telugu
    treatment_iui_title: "IUI",
    treatment_iui_desc: "గర్భాశయంలో కృత్రిమ గర్భధారణ ప్రక్రిया, విజయ రేట్లు మరియు ఏమి ఆశించవచ్చు",
    treatment_ivf_title: "IVF",
    treatment_ivf_desc: "ఇన్ విట్రో ఫెర్టిలైజేషన్ దశలు, టైమ్‌లైన్ మరియు సిద్ధత గైడ్",
    treatment_icsi_title: "ICSI",
    treatment_icsi_desc: "పురుష కారణ వంధ్యత్వం కోసం అండంలో స్పెర్మ్ ఇంజెక్షన్",
    treatment_donor_title: "దాత ఎంపికలు", 
    treatment_donor_desc: "అండం, స్పెర్మ్ మరియు పిండ దానం ప్రక్రియలు మరియు పరిగణనలు",
    treatment_preservation_title: "ప్రజనన సంరక్షణ",
    treatment_preservation_desc: "భవిష్యత్ కుటుంబ ప్రణాళిక కోసం అండం మరియు స్పెర్మ్ ఫ్రీజింగ్",

    // Sakhi Features - Telugu
    sakhi_feature_emotional_title: "భావోద్వేగ మద్దతు",
    sakhi_feature_emotional_desc: "ఆందోళన, భయం మరియు అధిక ఒత్తిడి క్షణాలకు సానుభూతిపూర్వక ప్రతిస్పందనలు",
    ...
    sakhi_feature_partner_desc: "కలిసి ప్రయాణంలో ఉన్న ఇద్దరు భాగస్వాములకు మార్గదర్శనం",
    sakhi_feature_multilang_title: "బహుభాష",
    sakhi_feature_multilang_desc: "మీ ఇన్‌పుట్ ఆధారంగా ఇంగ్లీష్, హిందీ లేదా తెలుగులో సమాధానం",
    ...
    chat_understand_anxiety: "మీ ఆందోళన నేను అర్థం చేసుకుంటున్నాను. స్కాన్‌లకు ముందు ఇలా అనిపించడం పూర్తిగా సాధారణం.",
